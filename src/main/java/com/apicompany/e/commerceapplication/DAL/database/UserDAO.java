...
public class UserDAO {
    ...
    public ArrayList<User> getAllUsers() {
        ...
        ResultSet rs;
        try {
            selectStatement = dbHandler.con.prepareStatement("SELECT * FROM USER ");
    ...
    public User getUser(int id) {
        ...
        ResultSet rs;
        try {
            selectStatement = dbHandler.con.prepareStatement("SELECT * FROM USER WHERE userId = ?");
    ...
    public User getUser(String userName) {
        ...
        ResultSet rs;
        try {
            selectStatement = dbHandler.con.prepareStatement("SELECT * FROM USER WHERE userName = ?");
    ...
    public boolean addUser(User user) {
        ...
        boolean isAdded;
        try {
            insertStatement = dbHandler.con.prepareStatement("INSERT INTO USER (userName,birthdate,"
    ...
    public boolean updateUser(User user) {
        ...
        try {
            updateStatement = dbHandler.con.prepareStatement("UPDATE USER SET userName = ? , birthdate = ? , "
    ...
    public boolean removeUser(User user) {
        ...
        int userID = user.getUserId();
        try {
            deleteStatement = dbHandler.con.prepareStatement("DELETE FROM USER WHERE userId = ?");
